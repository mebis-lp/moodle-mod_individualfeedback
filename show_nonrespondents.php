...
// $SESSION->individualfeedback->current_tab = $do_show;
...
$matchcount = individualfeedback_count_incomplete_users($cm, $usedgroupid);
...
$students = individualfeedback_get_incomplete_users($cm, $usedgroupid, $sort, $startpage, $pagecount, true);
//####### viewreports-start
...
if (empty($students)) {
    ...
    if (has_capability('moodle/course:bulkmessaging', $coursecontext)) {
        ...
        echo '<input type="submit" name="send_message" value="'.get_string('send', 'individualfeedback').'" />';
        echo '</div>';
        ...
        $module = array('name'=>'mod_individualfeedback', 'fullpath'=>'/mod/individualfeedback/individualfeedback.js');
        $PAGE->requires->js_init_call('M.mod_individualfeedback.init_sendmessage', null, false, $module);
    }
}
