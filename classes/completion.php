...
/**
 * Contains class mod_individualfeedback_completion
 *
...
class mod_individualfeedback_completion extends mod_individualfeedback_structure {
     ...
     */
    public function __construct($individualfeedback, $cm, $courseid, $iscompleted = false, $completedid = null, $userid = null) {
        global $DB;
        parent::__construct($individualfeedback, $cm, $courseid, 0);
    ...
    public function save_response() {
        ...
        if (individualfeedback_check_is_switchrole()) {
        ...
        if ($this->individualfeedback->anonymous == INDIVIDUALFEEDBACK_ANONYMOUS_NO) {
            individualfeedback_send_email($this->cm, $this->individualfeedback, $this->cm->get_course(), $USER, $this->completed);
        } else {
    ...
    public function process_page($gopage, $gopreviouspage = false) {
        ...
        if ($this->form->is_cancelled()) {
            ...
            $urltogo = course_get_url($this->courseid ?: $this->individualfeedback->course);
