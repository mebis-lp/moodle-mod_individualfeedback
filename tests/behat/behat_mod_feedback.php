...
class behat_mod_individualfeedback extends behat_base {
    ...
    public function i_add_question_to_the_individualfeedback_with($questiontype, TableNode $questiondata) {
        ...
        $additem = $this->escape(get_string('add_item', 'individualfeedback'));
        ...
        $saveitem = $this->escape(get_string('save_item', 'individualfeedback'));
    ...
    public function i_log_in_as_and_complete_individualfeedback_in_course($username, $individualfeedbackname, $coursename, TableNode $answers) {
        ...
        $this->execute('behat_general::click_link', $individualfeedbackname);
    ...
    protected function compare_exports($expected, $actual) {
        ...
        $dataexpected = $dataexpected['individualfeedback']['#']['ITEMS'][0]['#']['ITEM'];
        $dataactual = xmlize($actual, 1, 'UTF-8');
        $dataactual = $dataactual['individualfeedback']['#']['ITEMS'][0]['#']['ITEM'];
