...
Feature: individualfeedbacks in courses with groups
  ...
  Scenario: Non anonymous individualfeedback with groups in a course
    ...
    And I add a "Multiple choice" question to the individualfeedback with:
      ...
      | Multiple choice values         | Yes of course\nNot at all\nI don't know |
    And I log out
    And I log in as "user1" and complete individualfeedback "Course individualfeedback" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user2" and complete individualfeedback "Course individualfeedback" in course "Course 1" with:
      | I don't know | 1 |
    And I log in as "user3" and complete individualfeedback "Course individualfeedback" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user4" and complete individualfeedback "Course individualfeedback" in course "Course 1" with:
      | Yes of course | 1 |
    And I log in as "user5" and complete individualfeedback "Course individualfeedback" in course "Course 1" with:
      | Yes of course | 1 |
    And I log in as "user6" and complete individualfeedback "Course individualfeedback" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user7" and complete individualfeedback "Course individualfeedback" in course "Course 1" with:
      | I don't know | 1 |
  ...
  Scenario: Anonymous individualfeedback with groups in a course
    When I log in as "teacher"
    And I am on "Course 1" course homepage
    And I follow "Course anon individualfeedback"
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
    And I add a "Multiple choice" question to the individualfeedback with:
      | Question                       | Do you like this course?           |
      | Label                          | multichoice1                       |
      ...
      | Multiple choice values         | Yes of course\nNot at all\nI don't know |
    And I log out
    And I log in as "user1" and complete individualfeedback "Course anon individualfeedback" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user1"
    And I am on "Course 1" course homepage
    And I follow "Course anon individualfeedback"
    ...
    And I log out
    And I log in as "user2" and complete individualfeedback "Course anon individualfeedback" in course "Course 1" with:
      | I don't know | 1 |
    And I log in as "user3" and complete individualfeedback "Course anon individualfeedback" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user4" and complete individualfeedback "Course anon individualfeedback" in course "Course 1" with:
      | Yes of course | 1 |
    And I log in as "user5" and complete individualfeedback "Course anon individualfeedback" in course "Course 1" with:
      | Yes of course | 1 |
    And I log in as "user6" and complete individualfeedback "Course anon individualfeedback" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user7" and complete individualfeedback "Course anon individualfeedback" in course "Course 1" with:
      | I don't know | 1 |
    # View analysis, user1 should only see one group - group 1
    And I log in as "user1"
    And I am on "Course 1" course homepage
