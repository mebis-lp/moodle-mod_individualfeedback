...
Feature: Mapping courses in a individualfeedback
  ...
  Scenario: Course individualfeedback can not be mapped
    ...
    And I should not see "Map individualfeedback to courses"
  ...
  Scenario: Site individualfeedback is not mapped to any course
    ...
    And I should see "All courses" in the "#individualfeedback_course_filter [data-fieldtype=autocomplete] .form-autocomplete-selection [role=listitem]" "css_element"
    ...
    And I press "Filter"
    And I should see "Course 1" in the "#individualfeedback_course_filter [data-fieldtype=autocomplete] .form-autocomplete-selection [role=listitem]" "css_element"
    And I show chart data for the "multichoicerated" individualfeedback
  ...
  Scenario: Site individualfeedback is mapped to courses
    ...
    And I am on site homepage
    And I follow "Course individualfeedback"
    And I follow "Map individualfeedback to courses"
