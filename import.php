...
if ($choosefile) {
    ...
    if (!$xmldata = individualfeedback_load_xml_data($xmlcontent)) {
        print_error('cannotloadxml', 'individualfeedback', 'edit.php?id='.$id);
    }
...
function individualfeedback_import_loaded_data(&$data, $individualfeedbackid) {
    ...
    if ($deleteolditems) {
        ...
        $position = $DB->count_records('individualfeedback_item', array('individualfeedback'=>$individualfeedbackid));
    }
